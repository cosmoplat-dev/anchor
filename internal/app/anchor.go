...
import (
	...
	"github.com/cosmoplat-dev/anchor/internal/pkg/config"
	"github.com/cosmoplat-dev/anchor/pkg/allocator/anchor"
	"github.com/cosmoplat-dev/anchor/pkg/runtime/k8s"
	"github.com/cosmoplat-dev/anchor/pkg/store/etcd"
)
